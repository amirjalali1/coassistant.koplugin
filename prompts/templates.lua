...
-- Opt-in ultra-brief variant (quick_preset_nudge_strict): a hard countable
-- ceiling that REPLACES the standard nudge when the user turns it on.
Templates.QUICK_ANSWER_NUDGE_STRICT = "The reader wants an ULTRA-BRIEF answer right now: at most 3 short sentences, one plain paragraph. No preamble, no headings, no lists, never restate the question, no follow-up offers. Go deeper only if asked."
