                ...
                -- versions, and the spoiler mirror that steers checkpoint promotion
                {
                    ...
                    items = {
                        ...
                        },
                        {
                            ...
                            step = 3,
                            precision = "%d",
                            help_text = _("An entity page turns each of its connections into a tappable button. A richly connected character can carry dozens, which crowd the description off the screen. This caps how many buttons are drawn; the rest stay one tap away under \"All connections\". Repeated links to the same entity are always collapsed, whatever this is set to. 0 draws no buttons and lists every connection instead."),
                            separator = true,
                        },
                        {
